...
module.exports = function(
  ...
  const wrap = function(store) {
    return Object.keys(actions).reduce((wrappedActions, key) => {
      ...
      const wrappedAction = function(...args) {
        if (!reduxThunkAvailable) {
          ...
          return promiseChain([
            promiseWrapper(() => {
              if (before) {
                return store.dispatch(before.call(this, ...args))
              }
            }),
            promiseWrapper(() => {
              return store.dispatch(action.call(this, ...args))
            ...
            promiseWrapper(() => {
              if (after) {
                return store.dispatch(after.call(this, ...args))
              }
            }),
          ])
        }
      ...
      Object.defineProperty(wrappedActions[key], '_context', {
        value: actionContext,
      })
